# -*- coding: utf-8 -*-
"""
Created on Wed Apr 10 10:57:41 2019
Author: SK Nanda
"""
import os
import sys
...
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "Model_Roof.h5")
...
class RooftopConfig(Config):
    ...
    NUM_CLASSES = 12  # Background + objects
...
class RooftopDataset(utils.Dataset):
    def load_VIA(self, dataset_dir, subset, hc=False):
        """Load the rooftop dataset from VIA.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val or predict
        """
        # Add classes. We have only one class to add.
        self.add_class("Object", 1,  "Roof")
        self.add_class("Object", 2,  "Chimney")
        self.add_class("Object", 3,  "Road")
        self.add_class("Object", 4,  "Parking_Area")
        self.add_class("Object", 5,  "Tree")
        self.add_class("Object", 6,  "Land")
        self.add_class("Object", 7,  "Water_Body")
        self.add_class("Object", 8,  "Boat")
        self.add_class("Object", 9,  "Vehicle")
        self.add_class("Object", 10, "Unidentified_objects")
        ##  Solar_Paneles
        self.add_class("Object", 11, "Half_Roof")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a rooftop dataset image, delegate to parent class.
        ...
        # In the rooftop dataset, pictures are labeled with name 'a' and 'r' representing arm and ring.
...
def detect_and_color_splash(model, image_path=None, video_path=None, out_dir=''):
    ...
    class_names = ['BG','Roof','Chimney','Road', 'Parking_Area', 'Tree',  'Land', 'Water_Body', 'Boat', 'Vehicle',  'Unidentified_objects', 'Half_Roof']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        metavar="/home/santosh/mask_rcnn/data/rooftop",
                        help='Directory of the rooftop dataset')
    parser.add_argument('--weights', required=True,
                        metavar="/home/santosh/logs/weights.h5",
