...
class RooftopDataset(utils.Dataset):
    def load_VIA(self, dataset_dir, subset, hc=False):
        ...
        self.add_class("Object", 4,  "Parking Area")
        self.add_class("Object", 5,  "Tree")
        self.add_class("Object", 6,  "Land")
        self.add_class("Object", 7,  "Water Body")
        self.add_class("Object", 8,  "Boat")
        self.add_class("Object", 9,  "Vehicle")
        self.add_class("Object", 10, "Unidentified objects")
        ##  Solar_Paneles
        self.add_class("Object", 11, "Half Roof")
...
def detect_and_color_splash(model, image_path=None, video_path=None, out_dir=''):
    ...
    class_names = ['BG','Roof','Chimney','Road', 'Parking Area', 'Tree',  'Land', 'Water Body', 'Boat', 'Vehicle',  'Unidentified objects', 'Half Roof']
